...
const PROJECTS = [
  {
    ...
    category: ["sql"],
    desc: "Designed and queried a hospital management database to surface patient, billing and resource-utilization insights using advanced SQL.",
    github: "https://github.com/your-github/hospital-management-analytics"
  },
  {
    title: "Zomato Ratings EDA",
    tools: ["Python", "Pandas"],
    category: ["python"],
    desc: "Exploratory data analysis on restaurant ratings data — cleaning, trend analysis, and visualizing what drives higher ratings.",
    github: "https://github.com/your-github/zomato-ratings-eda"
  },
  {
    title: "Layoff Records Data Cleaning",
    tools: ["PostgreSQL"],
    category: ["sql"],
    desc: "Cleaned and standardized a messy global layoffs dataset — deduplication, null handling, and standardization using SQL.",
    github: "https://github.com/your-github/layoffs-data-cleaning"
  },
  {
    title: "Power BI Dashboards",
    tools: ["Power BI", "DAX"],
    category: ["powerbi"],
    desc: "Built a set of interactive Power BI dashboards with custom DAX measures for sales and operational reporting.",
    github: "https://github.com/your-github/power-bi-dashboards"
  },
  {
    title: "Election Data Processing Automation",
    tools: ["Python", "OCR", "Excel"],
    category: ["python", "automation"],
    desc: "Automated the extraction, cleaning and matching of electoral roll data using OCR and Python, cutting manual processing time significantly.",
    github: "https://github.com/your-github/election-data-automation"
  }
];
...
function setTheme(theme) {
  ...
  try { localStorage.setItem('sr-theme', theme); } catch (e) {}
}
...
function typeLoop() {
  ...
  if (!isDeleting && charIndex > current.length) {
    isDeleting = true;
    speed = 1400; // pause at full phrase
  } else if (isDeleting && charIndex < 0) {
    isDeleting = false;
...
function renderProjects(list) {
  projectsGrid.innerHTML = list.map(p => `
    <div class="project-card reveal visible" data-category="${p.category.join(' ')}">
      <h3>${p.title}</h3>
